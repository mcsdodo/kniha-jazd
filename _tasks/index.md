...
| 60 | [Paperless Integration](60-paperless-integration/) | 🟡 In Progress | Optional Paperless-ngx as invoice source; doklady mode switch + new `paperless_trip_links` table |
