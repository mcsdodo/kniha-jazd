...
const en = {
	...
	backup: {
		...
		vehiclesAndTrips: '{vehicles} {{vehicles:vehicle|vehicles}}, {trips} {{trips:trip|trips}}',
		...
		retention: {
			...
			toDelete: 'To delete: {count} {{count:backup|backups}} ({size})',
			cleanNow: 'Clean now',
	...
	toast: {
		...
		receiptsLoaded: 'Loaded {count} new {{count:receipt|receipts}}',
		receiptsLoadedWithErrors: 'Loaded {count} {{count:receipt|receipts}} ({errors} {{errors:error|errors}})',
		receiptsProcessed: 'Processed {count} {{count:receipt|receipts}}',
		receiptsProcessedWithErrors: 'Processed {count} {{count:receipt|receipts}} ({errors} {{errors:error|errors}})',
		foundNewReceipts: 'Found {count} new {{count:file|files}}',
	...
	paperless: {
		...
		customFields: {
			...
			sectionDescription: 'Pick which fields from your Paperless server hold the date, liters, and total amount.',
			datetime: 'Datetime field',
			liters: 'Liters field',
			total: 'Total amount field',
			useDefault: '(default: {name})',
			refresh: 'Refresh field list',
			loading: 'Loading custom fields…',
			loadError: 'Could not load custom fields from Paperless. Check your settings and try refreshing.',
			noCompatibleFields: 'No compatible field found — create a field of the right type in Paperless.',
		},
	},
	doklady: {
		paperless: {
