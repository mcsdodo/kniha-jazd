...
const en = {
	...
	doklady: {
		paperless: {
			...
			noDate: '?',
			notConfigured: 'Paperless-ngx is not configured.',
			openSettings: 'Open settings',
			unlinkedBadge: 'Unassigned invoices',
			assigned: 'Assigned',
			...
			unassign: 'Unassign',
			unassignTitle: 'Unassign invoice',
			unassignMessage: 'Are you sure you want to unassign invoice "{name}" from the trip?',
			noInvoices: 'No invoices.',
			assignedToast: 'Invoice assigned to trip',
