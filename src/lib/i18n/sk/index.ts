...
const sk = {
	...
	doklady: {
		paperless: {
			...
			unassignTitle: 'Zrušiť priradenie',
			unassignMessage: 'Naozaj chcete zrušiť priradenie dokladu "{name:string}" k jazde?',
			noInvoices: 'Žiadne doklady.',
			assignedToast: 'Doklad bol pridelený k jazde',
