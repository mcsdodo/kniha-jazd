...
const sk = {
	...
	backup: {
		...
		vehiclesAndTrips: '{vehicles:number} {{vehicles:|vozidlo||vozidlá||vozidiel}}, {trips:number} {{trips:|jazda||jazdy||jázd}}',
		...
		retention: {
			...
			toDelete: 'Na vymazanie: {count:number} {{count:|záloha||zálohy||záloh}} ({size:string})',
	...
	confirm: {
		...
		unassignReceiptTitle: 'Zrušiť priradenie',
		unassignReceiptMessage: 'Naozaj chcete zrušiť priradenie dokladu "{name:string}" k jazde?',
		unassignConfirm: 'Zrušiť priradenie',
		revertOverrideTitle: 'Zrušiť potvrdenie',
		revertOverrideMessage: 'Naozaj chcete zrušiť potvrdenie nezhody pre doklad "{name:string}"?',
		revertOverrideConfirm: 'Zrušiť potvrdenie',
	},
	...
	receipts: {
		...
		unassigned: '{count:number} {{count:|nepriradený||nepriradené||nepriradených}}',
		// Section headers
	...
	tripSelector: {
		...
		mismatchTimeAndLiters: 'čas mimo jazdy a iné litre',
	...
	toast: {
		...
		receiptUnassigned: 'Priradenie dokladu bolo zrušené',
		overrideReverted: 'Potvrdenie nezhody bolo zrušené',
		...
		receiptsLoaded: '{{count:|Načítaný||Načítané||Načítaných}} {count:number} {{count:|nový||nové||nových}} {{count:|doklad||doklady||dokladov}}',
		receiptsLoadedWithErrors: '{{count:|Načítaný||Načítané||Načítaných}} {count:number} {{count:|doklad||doklady||dokladov}} ({errors:number} {{errors:|chyba||chyby||chýb}})',
		receiptsProcessed: '{{count:|Spracovaný||Spracované||Spracovaných}} {count:number} {{count:|doklad||doklady||dokladov}}',
		receiptsProcessedWithErrors: '{{count:|Spracovaný||Spracované||Spracovaných}} {count:number} {{count:|doklad||doklady||dokladov}} ({errors:number} {{errors:|chyba||chyby||chýb}})',
		foundNewReceipts: '{{count:|Nájdený||Nájdené||Nájdených}} {count:number} {{count:|nový||nové||nových}} {{count:|súbor||súbory||súborov}}',
		...
		errorUnassignReceipt: 'Nepodarilo sa zrušiť priradenie dokladu',
		errorRevertOverride: 'Nepodarilo sa zrušiť potvrdenie',
	...
	places: {
		...
		uses: '{count:number} {{count:|výskyt||výskyty||výskytov}}',
		// Edit dialog
	...
	homeAssistant: {
		...
		fillupSensorLabel: 'Návrh tankovania (input_text)',
		fillupSensorPlaceholder: 'input_text.kniha_jazd_fillup',
		fillupSensorHint: 'Entity ID input_text helpera v HA. Vytvorte ho v Nastavenia → Zariadenia → Helpery → Vytvoriť → Text.',
	...
	paperless: {
		...
		customFields: {
			...
			sectionDescription: 'Vyber, ktoré polia z tvojho Paperless servera obsahujú dátum, litre a sumu.',
			datetime: 'Pole pre dátum/čas',
			liters: 'Pole pre litre',
			total: 'Pole pre sumu',
			useDefault: '(predvolené: {name:string})',
			refresh: 'Obnoviť zoznam polí',
			loading: 'Načítavam vlastné polia…',
			loadError: 'Nepodarilo sa načítať vlastné polia z Paperless. Skontroluj nastavenia a skús obnoviť.',
			noCompatibleFields: 'Žiadne kompatibilné pole — vytvor v Paperless pole správneho typu.',
		},
	},
	doklady: {
		paperless: {
