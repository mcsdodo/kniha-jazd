...
pub fn is_datetime_in_trip_range(datetime: NaiveDateTime, trip: &Trip) -> bool {
...
pub fn get_year_start_fuel_remaining(
    db: &Database,
    vehicle_id: &str,
    year: i32,
    tank_size: f64,
...
pub fn get_year_start_battery_remaining(
    db: &Database,
    vehicle_id: &str,
    year: i32,
    vehicle: &Vehicle,
...
pub fn get_year_start_odometer(
    db: &Database,
    vehicle_id: &str,
    year: i32,
...
pub fn get_open_period_km(chronological: &[Trip], stop_at_trip_id: Option<&Uuid>) -> f64 {
...
pub fn calculate_suggested_fillups(
    chronological: &[Trip],
    tp_consumption: f64,
...
pub fn calculate_fuel_consumed(
    trips: &[Trip],
...
pub fn calculate_fuel_remaining(
    chronological: &[Trip],
    rates: &HashMap<String, f64>,
    initial_fuel: f64,
    tank_size: f64,
...
pub fn calculate_energy_grid_data(
    chronological: &[Trip],
    vehicle: &Vehicle,
    initial_battery: f64,
) -> (
