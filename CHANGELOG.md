...
- **Mapa trasy sleduje skutočné miesto odchodu a príchodu** — trasa na mape sa už nekreslí ako náhodná okružná jazda z domovskej obce, ale podľa toho, čo je zapísané v poliach „Odkiaľ“ a „Kam“. Ak sú rovnaké, mapa zostáva okružnou trasou ako doteraz; inak vedie priamo z jedného miesta do druhého. Súradnice sa berú zo zoznamu Miesta — ak niektoré z nich ešte nemá určený bod na mape, otvorí sa rovno tu dialóg na jeho umiestnenie, bez odchodu zo stránky. Pre priamu trasu bez medzizastávky aplikácia ponúka aj viacero trás na výber zoradených od najrýchlejšej a trasu možno doladiť potiahnutím čiary myšou, čím sa pridá medzizastávka.
- **Cesta tam a späť na mape trasy** — pri vytváraní trasy v režime „Priamo“ pribudlo políčko „Cesta tam a späť“. Po zaškrtnutí sa trasa dopočíta späť do miesta odchodu, takže jazdu zapísanú ako jeden riadok vieš porovnať so skutočne okružnou trasou namiesto jednosmernej. Voľba sa ukladá spolu s trasou, takže po opätovnom otvorení mapy k danej jazde sa políčko vráti do stavu, v akom si ho uložil.
- **Upozornenie na nesúlad tachometra** — v knihe pribudlo červené upozornenie pri zázname, ktorého stav tachometra nesedí so zapísanými kilometrami. Rozdiel počítaného úseku a zapísaného počtu kilometrov vidíš priamo v popise pri stĺpci ODO, takže je zrejmé, o koľko kilometrov ide. Druhé upozornenie sa objaví pri dátume, ak má rovnaký dátum a čas viac jázd — poradie takých riadkov potom určí poradie zápisu, nie poradie jazdenia, a práve tam sa nesúlad tachometra rád skryje. Obe upozornenia sú len upozornenia: záznam sa vždy uloží, aby sa dala oprava spraviť po krokoch. Počet označených riadkov nájdeš v legende nad tabuľkou.
...
- **Potvrdenie nesúladu pri doklade z Paperless zostáva uložené** -- ak priradíš doklad k jazde, ktorej údaje nesedia, a nesúlad potvrdíš, aplikácia si to zapamätá. V knihe sa pri takom zázname ukáže značka "potvrdené" namiesto upozornenia na nesúlad. Potvrdenie vieš zrušiť na stránke Doklady tlačidlom pri doklade, priradenie pritom zostane. Doteraz sa potvrdenie zahodilo a upozornenie sa vrátilo pri každom načítaní.
- **Upozornenie na dátum a čas dokladu platí aj pre doklady z Paperless** -- ak dátum a čas dokladu nespadá do času jazdy, kniha záznam označí. Doteraz to vedeli len miestne doklady. Pri priradení sa dátum a čas dokladu odloží, takže neskoršia zmena v Paperless sa v knihe neprejaví. Ak doklad k jazde priraďuješ a dátum nesedí, aplikácia ti nesúlad ponúkne rovno potvrdiť, takže upozornenie v knihe vieš vypnúť.

### Zmenené
- **Úprava, pridanie aj vymazanie záznamu môžu posunúť tachometer neskorších záznamov** - predtým sa to dialo potichu, na riadkoch, ktorých si sa vôbec nedotkol, a bez opýtania. Teraz úprava počtu kilometrov alebo stavu tachometra, nový záznam aj vymazanie záznamu posunú stav tachometra všetkých neskorších záznamov toho istého roka o rovnaký rozdiel, ale až po tom, čo aplikácia vopred ukáže presné riadky a o koľko kilometrov sa ich tachometer zmení, a ty to potvrdíš. Pridanie záznamu na koniec aktuálneho roka nič neposúva a nič sa nepýta. Hromadný prepočet celého roka zostal ako samostatný príkaz s dvoma krokmi: náhľad, ktorý vypíše, ktoré riadky a na aké hodnoty by zmenil, a nezapíše nič, a zápis, ktorý spustíš až po schválení náhľadu. Spúšťa sa cez rozhranie RPC a v aplikácii preň nie je tlačidlo, lebo prepísanie celého reťazca by zmazalo aj upozornenia na nesúlad tachometra - a práve tie chybu ukazujú. Kým máš niektorý záznam otvorený na úpravu, tlačidlá, ktoré by posunuli jeho tachometer - nový záznam, vloženie nad, kopírovanie a odstránenie - sú neaktívne, takže sa otvorený riadok nedá uložiť s číslom, ktoré medzitým prestalo platiť. Neaktívne sú aj krátku chvíľu po kliknutí na odstránenie, kým sa neukáže potvrdenie - v tej chvíli sa nedá otvoriť na úpravu ani žiadny iný záznam. Ak zadáš stav tachometra nižší, než má predchádzajúci záznam, aplikácia zápis odmietne a napíše dôvod, nielen že sa záznam nepodarilo uložiť.

### Opravené
- **Doklady o tankovaní priradené pred zavedením viacerých dokladov na jazdu boli označené ako "iné náklady"** -- pri prechode na viac dokladov sa staré priradenia z Paperless označili nesprávne, takže kniha hlásila chýbajúci doklad o tankovaní aj pri jazdách, ktoré doklad mali. Aktualizácia ich opraví pri migrácii, ešte pred zrušením tabuľky miestnych dokladov. V tvojej knihe sa tým opraví 11 priradení a zmizne 11 nesprávnych upozornení.
- **Stĺpec "Km pred" teraz vždy nadväzuje na predchádzajúci riadok** - o poradí jázd rozhodovali tri rôzne pravidlá, dve z nich v prehliadači. Pri jazdách s rovnakým dátumom a časom tak tabuľka mohla ukázať iné poradie, než z akého sa počítal stav tachometra na začiatku jazdy. Poradie teraz určuje jediné pravidlo v backende: dátum a čas, potom čas zápisu, potom stav tachometra, potom identifikátor záznamu. V knihe sa tým zmenilo poradové číslo 62 záznamov z rokov 2023 až 2025, rok 2026 zostal nedotknutý. Vždy ide len o preusporiadanie jázd s rovnakým dátumom a časom - žiadny dátum, trasa, počet kilometrov ani stav tachometra sa nemení.
- **Úprava riadku brala stav tachometra zo susedného riadku na obrazovke** - predvyplnený stav tachometra sa čítal z riadku nad upravovaným záznamom, teda z toho, čo bolo práve zobrazené. Teraz ho dodáva backend z toho istého poradia, z akého sa počíta aj stĺpec "Km pred", takže sa obe čísla nemôžu rozísť.
...
- **Desatinné kilometre nemali živý náhľad** - ak si do počtu kilometrov zapísal desatinné číslo, napríklad 100,5, backend takú požiadavku odmietol a riadok nedostal ani spotrebu, ani zostatok. Počet kilometrov je teraz desatinné číslo na celej ceste od políčka až po výpočet, takže náhľad odpovie rovnako na celé aj na desatinné kilometre.
...
### Odstránené
- **Miestne skenovanie dokladov a AI rozpoznávanie (Gemini)** -- z aplikácie zmizlo skenovanie blokov z priečinka, rozpoznávanie textu cez Gemini aj miestna záložná cesta pre doklady. Paperless-ngx je teraz jediný zdroj dokladov. Ak Paperless nie je nastavený, aplikácia funguje ďalej bez dokladov a stránka Doklady zobrazí návod na jeho nastavenie.
- **Tabuľka `receipts` sa pri aktualizácii zruší** -- miestne doklady sa nenávratne zahodia. Doklady priradené k jazde ostávajú ako odkazy na Paperless; ostatné riadky zmiznú. Ak ich ešte potrebujete, vyexportujte si ich **pred** aktualizáciou: `sqlite3 -header -csv data/kniha-jazd.db "SELECT * FROM receipts;" > receipts.csv`. Aplikácia pred migráciou uloží zálohu do `<DATA_DIR>/backups/kniha-jazd-backup-*-pre-migration-*.db` a nikdy ju nemaže, takže sa z nej dá tabuľka prečítať cez `sqlite3`. Obnova zálohy doklady nevráti -- nová verzia pri štarte znova spustí migrácie a tabuľku znova zruší.
...
### Opravené
- **Úprava tokenu hlásila chybu o URL** — ak bola cez premennú prostredia nastavená len adresa (napr. `HA_URL`), aplikácia pri uložení tokenu poslala aj adresu a uloženie skončilo chybou. Polia spravované premennými sa už neposielajú, takže zvyšné sa dajú normálne upraviť.
- **Priečinok s dokladmi sa nedal nastaviť v prehliadači** — jediná možnosť bolo tlačidlo otvárajúce natívny dialóg, ktorý v prehliadači nefunguje. V serverovom režime je teraz cesta k priečinku (na serveri) obyčajné textové pole.

## [0.40.1] - 2026-08-07

### Opravené
- **„Otvoriť v Paperless" v prehliadači/serverovom režime nič nespravilo** — tlačidlo používalo desktopový Tauri plugin, ktorý v prehliadači neexistuje. Dokument sa teraz otvorí v novej karte. Rovnako opravený aj odkaz na changelog v Nastaveniach.
...
- **Ignorovanie poškodených trás pri automatickom predvyplnení KM** - ak je v tabuľke `routes` uložená absurdne veľká vzdialenosť (> 9999 km) z predchádzajúcej chybnej jazdy, predvyplnenie KM sa preskočí. Zabraňuje tomu, aby sa stará poškodená hodnota opakovane dostala do nových riadkov.
