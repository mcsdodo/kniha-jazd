...
- **Tabuľka `receipts` sa pri aktualizácii zruší** -- miestne doklady sa po aktualizácii už nedajú načítať. Ak ich ešte potrebujete, spustite `scripts/migrate_local_to_paperless.py` **pred** aktualizáciou; skript ich prenesie do Paperless-ngx.
